...
# Create a base instance as a golden image for the CWL training
# laboratory. The image will be then configured adding the applications
# and the enviroment required for the tutorials.
...
gcloud compute ssh ubuntu@cwl-lab-golden --zone=europe-west2-b
